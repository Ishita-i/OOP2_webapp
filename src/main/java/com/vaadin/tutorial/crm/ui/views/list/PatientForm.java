...
public class PatientForm extends FormLayout {
    ...
    TextField assurancenr = new TextField("Assurancenr");
    ComboBox<Company> company = new ComboBox<>("Company Assurance");
    TextField lastVisited = new TextField("Last Visited");
    TextField address = new TextField("Address");
    TextField issues = new TextField("Issues");
    ...
    public PatientForm(List<Company> companies) {
